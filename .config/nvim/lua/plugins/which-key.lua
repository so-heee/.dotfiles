return {
	...
	config = function()
		...
		wk.add({
			...
			{ "<leader>lF", "<cmd>lua vim.lsp.buf.format()<CR>", desc = "フォーマット", mode = { "n", "v" } },
			...
			{ "<leader>ds", "<cmd>Lspsaga show_line_diagnostics<CR>", desc = "行診断表示", mode = "n" },
			...
			{ "gt", "<cmd>Lspsaga peek_type_definition<CR>", desc = "型定義プレビュー", mode = "n" },
